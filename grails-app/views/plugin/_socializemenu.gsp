<nav class="socialize-menu">
    ...
    <ul>
        ...
        <li><a href="https://slack.grails.org" class="icon"><span class="fa fa-slack"></span> Discuss on Slack</a></li>
        ...
        <li><a href="https://stackoverflow.com/questions/tagged/grails" class="icon"><span class="fa fa-stack-overflow"></span> Stack Overflow questions</a></li>
    </ul>
</nav>
