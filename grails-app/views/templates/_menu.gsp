<nav class="thirdmenu">
    <ul>
        <li class="active"><a href="http://plugins.grails.org/"><g:message code="nav.grails3plugins" default="Grails 3 Plugins"/></a></li>
        <li><a href="https://grails.org/plugins/"><g:message code="nav.grails2plugins" default="Grails 1 & 2 Plugins"/></a></li>
