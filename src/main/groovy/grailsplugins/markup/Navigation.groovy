package grailsplugins.markup

import groovy.transform.CompileStatic
import grailsplugins.markup.model.IconMenuItem
import grailsplugins.markup.model.Menu
import grailsplugins.markup.model.MenuItem
import grailsplugins.markup.model.TextMenuItem
...
class Navigation {
    ...
    static Menu parternsMenu(String url) {
        new Menu(items: [
                new TextMenuItem(intro: 'Grails\' repositories are hosted by', title: 'Artifactory', href: 'https://jfrog.com/artifactory/'),
